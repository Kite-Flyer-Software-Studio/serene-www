    ...
    <div className="flex w-full flex-col items-center">
      ...
      <div className="w-full px-2 py-3">
        <div className="bg-[#FAF0E6] rounded-xl p-2 w-full">
          ...
          <p className="text-[#7B6B63] text-xs mt-1">Saturday, 2:00 PM</p>
          <div className="flex items-center justify-between gap-4">
            <div className="flex flex-col items-start mt-4 gap-1">
              ...
              <div className="flex items-center gap-2">
                <span className="text-xs text-[#7B6B63]">
                  at Serene Coffee & Wine
                </span>
              </div>
            </div>
      ...
      <div className="w-full px-2 py-3">
        <div className="bg-[#D3E7FF] rounded-xl p-2 w-full">
          ...
          <p className="text-[#7B6B63] text-xs mt-1">Thursday, 6:30 PM</p>
          <div className="flex items-center justify-between gap-4">
            <div className="flex flex-col items-start mt-4 gap-1">
              <div className="flex -space-x-2">
                <Image
