...
export default function LanguageSelect() {
  ...
  return (
    <li className="languageSelect">
      ...
      >
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" width="14" height="21" viewBox="0 0 52 64" className="language-globe-icon">
        ...
        <span style={{ lineHeight: 'normal' }}>{localeCopy}</span>
      </Link>
    </li>
  );
}
