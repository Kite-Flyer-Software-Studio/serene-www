const valuePropsOne = [
  ...
  {
    title: 'Swiping is overrated',
    description:
      "Forget swiping—Serene uses advanced AI to match you based on your true needs. Experience the new trend in authentic connections.",
    svgPath:
  ...
  {
    title: 'Best IRL Social Events',
    description:
      'Enjoy exclusive Serene member events—from wine tastings and DJ nights to paint & sip sessions—bringing people together for fun, connection, and unforgettable experiences.',
    svgPath:
